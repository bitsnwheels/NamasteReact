    ...
    return (
        <div className="header">
            <div className="logo-container">
                <img className="logo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEb4NTdqXlBcqoiBHzVNQezU45G8UsxSlSJA&s"></img>
            </div>
...
const RestaurantCard =(props) =>{
  ...
  const {
    ...
    cuisines,
    costForTwo,
    sla, // This contains delivery info
  } = data;
    ...
    return (
        <div className="body"> 
            ...
            <div className="res-container">
                ...
                {/* {
                  restaurantList.map(restaurant => <RestaurantCard data={restaurant}/>)
                } */}

                {
                  restaurantList.map((restaurant) => (<RestaurantCard key={restaurant.data.id} data={restaurant.data} />))
                }
                ...
                <RestaurantCard data={restaurantList[1].data}/>
                <RestaurantCard data={restaurantList[2].data}/>
                <RestaurantCard data={restaurantList[3].data}/>
                <RestaurantCard data={restaurantList[5].data}/>
                <RestaurantCard data={restaurantList[6].data}/>
                <RestaurantCard data={restaurantList[7].data}/>
                <RestaurantCard data={restaurantList[8].data}/>
                <RestaurantCard data={restaurantList[9].data}/> */}
